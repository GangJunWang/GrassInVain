...
public class PtrMyDefaultHeaderWhite extends FrameLayout implements PtrUIHandler {
    ...
    public PtrMyDefaultHeaderWhite(Context context) {
        super(context);
        initViews(null);
    }

    public PtrMyDefaultHeaderWhite(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViews(attrs);
    }

    public PtrMyDefaultHeaderWhite(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void initViews(AttributeSet attrs) {
        ...
        buildAnimation();
        View header = LayoutInflater.from(getContext()).inflate(R.layout.layout_ptr_my_default_header_white, this);
