package bluetooth.inuker.com.grassinvain.common.widget.ultra.header;
...
import bluetooth.inuker.com.grassinvain.common.widget.ultra.PtrUIHandler;
import bluetooth.inuker.com.grassinvain.common.widget.ultra.indicator.PtrIndicator;


public class PtrMyDefaultHeaderBlack extends FrameLayout implements PtrUIHandler {
    ...
    public PtrMyDefaultHeaderBlack(Context context) {
        super(context);
        initViews(null);
    }

    public PtrMyDefaultHeaderBlack(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViews(attrs);
    }

    public PtrMyDefaultHeaderBlack(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void initViews(AttributeSet attrs) {
        ...
        buildAnimation();
        View header = LayoutInflater.from(getContext()).inflate(R.layout.layout_ptr_my_default_header_black, this);
    ...
    public void onUIRefreshPrepare(PtrFrameLayout frame) {
        ...
        if (frame.isPullToRefresh()) {
            mTitleTextView.setText(getResources().getString(R.string.pull_to_refresh));
        } else {
            mTitleTextView.setText(getResources().getString(R.string.pull_to_refresh));
        }
    }
    ...
    public void onUIRefreshComplete(PtrFrameLayout frame) {
        ...
        mTitleTextView.setVisibility(VISIBLE);
        mTitleTextView.setText(getResources().getString(R.string.refresh_succeed));
        ...
        if (seconds < 60) {
            ...
            if (minutes > 60) {
                ...
                if (hours > 24) {
                    ...
                    sb.append(hours + getContext().getString(R.string.release_to_refresh));
                }
