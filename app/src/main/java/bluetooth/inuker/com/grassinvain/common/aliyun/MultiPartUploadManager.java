...
public class MultiPartUploadManager {
    ...
    public PauseableUploadTask asyncUpload(String objectName, String localFileName) {
        ...
        Logger.d("AsyncMultiPartUpload", "Begin");
        Logger.d("Object", objectName);
        Logger.d("LocalFile", localFileName);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Logger.d("MultipartUploadMd5", totalMd5);
