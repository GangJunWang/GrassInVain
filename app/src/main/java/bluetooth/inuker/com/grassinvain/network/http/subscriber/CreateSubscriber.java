 ...
 */
public class CreateSubscriber<T> extends SubAPICallback<T> implements ProgressDialog.CancelProgressListener {
    //出错提示
    ...
    public CreateSubscriber(Context context, boolean hasProgress) {
